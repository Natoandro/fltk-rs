...
pub use fltk_sys::widget::Fl_Widget;
...
macro_rules! impl_widget_ext_via {
    ($widget:ty, $member:tt) => {
        unsafe impl WidgetExt for $widget {
            ...
            unsafe fn as_widget_ptr(&self) -> *mut fltk::macros::widget::Fl_Widget {
...
macro_rules! impl_widget_base_via {
    ($widget:ty, $base:ty, $member:tt) => {
        unsafe impl WidgetBase for $widget {
            ...
            unsafe fn from_widget_ptr(ptr: *mut fltk::macros::widget::Fl_Widget) -> Self {
